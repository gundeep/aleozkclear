...
function App() {
      ...
      .then(response => {
        xml2js.parseString(response.data, (err, result) => {
          if (err) {
            ...
            setYear(dateOfIssue['Year'][0]);
            setMonth(dateOfIssue['Month'][0]);
            setDay(dateOfIssue['Day'][0]);
  ...
  async function execute() {
    ...
    console.log("Days difference between date of the file and today", daysDiff().toString());
